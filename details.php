            ...
            <?php if(isset($_GET['k']) && isset($arrProducts[$_GET['k']])): ?> 
                ...
                <div class="col-md-8 col-sm-6 col-xs-12">
                    <div class="product-content">
                        ...
                        <h3>Select Size: </h3>
                        <input type="radio" name="radSize" id="radXS" value="XS" required> <label for="radXS" class="pr-3">XS</label>
                        <input type="radio" name="radSize" id="radSM" value="SM" required> <label for="radSM" class="pr-3">SM</label>
                        <input type="radio" name="radSize" id="radMD" value="MD" required> <label for="radMD" class="pr-3">MD</label>
                        <input type="radio" name="radSize" id="radLG" value="LG" required> <label for="radLG" class="pr-3">LG</label>
                        <input type="radio" name="radSize" id="radXL" value="XL" required> <label for="radXL" class="pr-3">XL</label>
                        <br>
                        <hr>
                        <h3 class="title"></h3>
